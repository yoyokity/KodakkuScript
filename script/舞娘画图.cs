...
public class 舞娘技能范围
{
    Vector4 大舞颜色 = new Vector4(1, 1, 1, .4f);
    Vector4 团辅颜色 = new Vector4(1, 1, 1, .1f);
    Vector4 小舞颜色 = new Vector4(1, 1, 1, .2f);
    ...
    {
        if (Svc.ClientState.LocalPlayer.GetJob() != Job.DNC) return;
